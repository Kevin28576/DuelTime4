...
public class CMDHelp extends SubCommand {
    ...
    public CMDHelp() {
        ...
        helpList = new UtilHelpList(Msg.COMMAND_TITLE_HELP, false)
                ...
                .add("send", new String[]{"send", "sd"}, "send(sd) <%player%> [%arena_name%]", null, Msg.COMMAND_SUB_SEND_DESCRIPTION)
                ...
                .add("queue", new String[]{"queue", "q"}, "queue(q) sound/cooldown", null, Msg.COMMAND_SUB_QUEUE_DESCRIPTION)
                ...
                .add("stats", new String[]{"stats", "stat"}, "stats(stat) [%player%]", null, Msg.COMMAND_SUB_STATS_DESCRIPTION)
